import {
  ...
  moveLeft,
  moveRight,
} from "./src/Movements/basicMovement.js";
...
const spaceship = document.getElementById("spaceship") as HTMLElement;
const laser = document.getElementById("laser") as HTMLElement;
//Kollar om det finns någon laser på skärmen
let laserPosition: any = null;
